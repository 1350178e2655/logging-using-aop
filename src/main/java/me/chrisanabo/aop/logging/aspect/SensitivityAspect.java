package me.chrisanabo.aop.logging.aspect;

import me.chrisanabo.aop.logging.annotation.LogEntryExit;
import me.chrisanabo.aop.logging.annotation.LogLevel;
...
//    @Pointcut("within(me.chrisanabo.aop.logging.pojo..*)"+
//            " || within(me.chrisanabo.aop.logging.pojo..*)"  )
    public void applicationPackagePointcut() {
        // Method is empty as this is just a Pointcut, the implementations are in the advices.

        System.out.println("asdfadfasfdasfas");
    }



    //@Around("execution(* *(..)) " +
   //        "&& @annotation(me.chrisanabo.aop.logging.annotation.Sensitivity)")
    @Around("execution(* me.chrisanabo.aop.logging.pojo(..))")
   ...
   //     Logger logger = LoggerFactory.getLogger(method.getDeclaringClass());
     //   var annotation = method.getAnnotation(Sensitivity.class);
...
//        boolean showExecutionTime = annotation.showExecutionTime();
   ...
   //     var duration = String.format("%s %s", unit.between(start, end), unit.name().toLowerCase());
     ...
     //   log(logger, level, exit(methodName, duration, response, showResult, showExecutionTime));
        ...
        System.out.println("i was executed asdfadfasf ");

        System.out.println("xxxxxxxxxxxx: TestAspect.advice(): aspect is called on " + point
                + ". This object: " + point.getThis());
